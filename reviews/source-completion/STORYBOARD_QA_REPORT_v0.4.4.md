# STORYBOARD_QA_REPORT — v0.4.4

Deck: `K5PL06T03B02_STORYBOARD_FOR_BARIAH_REVIEW_v0_4_4.pptx` — 100 review pages.

Suite: `generator/v0_4/b02_governance_qa_v0_4_4.py`, chaining the Stage 4.2C, 4.2B, 4.1 and Stage 4 suites unchanged.
...
> Supersession markers are **not tests**. They assert the constant `SUPERSEDED` so a retired ruling stays visible instead of vanishing. Counting them as passing checks would overstate coverage.
...
PASS  ORIGINAL_STAGE_4_CHECKS                                                                 116
...
PASS  STAGE_4_2B_SUITE_CHECKS                                                                 267
...
PASS  STAGE_4_2C_SUITE_CHECKS                                                                 311
